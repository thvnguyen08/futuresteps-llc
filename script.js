...
const translations = {
  vi: {
    ...
    "vb.title": "Bản Tin Visa — Tháng 9/2026",
    ...
    "news.n1.tag": "Lệnh Cấm Của Tòa Án",
    "news.n1.title": "Tòa Án Chặn Quy Định Xóa Bỏ \"Thời Gian Lưu Trú\" — Mẫu I-539/I-765 Cũ Vẫn Được Yêu Cầu",
    "news.n1.desc": "Ngày 14/9/2026, một thẩm phán liên bang tại Massachusetts đã ban hành lệnh cấm sơ bộ trên toàn quốc trong vụ Presidents' Alliance kiện DHS, ngăn chặn quy định thay thế \"Thời Gian Lưu Trú\" (D/S) bằng thời hạn nhập cảnh cố định 4 năm cho diện F-1, J-1 và I. Kết quả là USCIS không chấp nhận mẫu đơn phiên bản mới 09/15/26 của Mẫu I-539 và I-765, và tiếp tục yêu cầu dùng mẫu cũ phiên bản 08/28/24 và 08/21/25 — đảo ngược quy định \"không có thời gian ân hạn\" đã công bố hồi tháng 8. Sinh viên diện F-1 và khách trao đổi J-1 tạm thời vẫn giữ diện lưu trú D/S hiện tại, dù vụ kiện vẫn đang tiếp diễn với phiên điều trần dự kiến vào ngày 2/10.",
    "news.n2.tag": "Quy Định Public Charge",
    "news.n2.title": "Quy Định Public Charge Có Hiệu Lực Từ 18/9 Dù 22 Bang Kiện Yêu Cầu Chặn",
    "news.n2.desc": "Quy định Public Charge mới chính thức có hiệu lực từ ngày 18/9/2026, bãi bỏ khung quy định năm 2022 và cho phép viên chức USCIS xem xét phạm vi phúc lợi công rộng hơn — bao gồm SNAP, Medicaid và hỗ trợ nhà ở nhận được từ ngày đó trở đi — khi đánh giá đương đơn xin thẻ xanh có khả năng trở thành \"public charge\" (gánh nặng phúc lợi công) hay không. Ngày 14/9, tiểu bang New York dẫn đầu liên minh 22 bang, Washington D.C. và nhiều thành phố lớn nộp đơn kiện liên bang riêng biệt để chặn quy định này, nhưng chưa có tòa án nào ban hành lệnh cấm, nên Mẫu I-485 phiên bản mới 09/18/26 vẫn bắt buộc áp dụng, không có thời gian ân hạn, cho hồ sơ nộp từ ngày 18/9 trở đi.",
    "news.n3.tag": "Đề Xuất Phí H-1B",
    "news.n3.title": "DHS Đề Xuất Mức Phí 103.265 Đô La Cho Mỗi Đơn H-1B Diện Giới Hạn Số Lượng",
    "news.n3.desc": "Ngày 25/8/2026, DHS công bố dự thảo quy định trên Công Báo Liên Bang (Federal Register) đề xuất thu thêm 103.265 đô la — cộng dồn với tất cả các khoản phí hiện có — cho mỗi đơn H-1B diện giới hạn số lượng (cap-subject), dự kiến thu về khoảng 8,8 tỷ đô la mỗi năm từ khoảng 85.000 hồ sơ nộp hàng năm. Mức phí này áp dụng cho mọi nhà tuyển dụng nộp đơn diện cap bất kể quy mô, nhưng không áp dụng cho đơn miễn cap (trường đại học, tổ chức nghiên cứu phi lợi nhuận) hay đơn gia hạn, sửa đổi, chuyển chủ lao động của diện H-1B hiện tại; DHS nhận ý kiến đóng góp của công chúng đến hết ngày 24/9/2026, và nếu được thông qua, mức phí sẽ áp dụng lần đầu cho các đơn diện cap của năm tài chính 2028 (kỳ rút thăm mùa xuân 2027 cho ngày bắt đầu 1/10/2027).",
