...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Chính Sách Tị Nạn",
    "news.n1.title": "USCIS Cho Phép Viên Chức Tị Nạn Bỏ Qua Phỏng Vấn, Chuyển Thẳng Hồ Sơ Sang Tòa Di Trú",
    "news.n1.desc": "Ngày 27/7/2026, USCIS công bố quy định tạm thời có hiệu lực ngay, cho phép viên chức tị nạn chuyển thẳng đơn xin tị nạn chủ động (affirmative asylum) sang Tòa Di Trú mà không cần phỏng vấn trước, áp dụng cho các hồ sơ nộp trễ hơn một năm sau khi nhập cảnh, có tiền án nghiêm trọng, hoặc bị xác định không đủ điều kiện. DHS cho biết thay đổi này có thể ảnh hưởng đến khoảng 444.724 hồ sơ, tương đương 31% trong số 1,43 triệu hồ sơ tị nạn còn tồn đọng, nhằm giảm bớt tình trạng ùn ứ.",
    "news.n2.tag": "Visa Du Học",
    "news.n2.title": "DHS Chấm Dứt Quy Chế \"Duration Of Status\" Cho Diện F-1 Và J-1, Áp Dụng Thời Hạn Cư Trú Cố Định",
    "news.n2.desc": "Quy định chính thức công bố ngày 17/7/2026 thay thế quy chế cư trú không thời hạn cố định (\"duration of status\") dành cho sinh viên diện F-1, khách trao đổi diện J-1, và đại diện truyền thông nước ngoài diện I, bằng thời hạn cư trú cố định tối đa 4 năm, có hiệu lực từ ngày 15/9/2026. Sinh viên cần thêm thời gian phải nộp đơn xin gia hạn cư trú với USCIS trước khi mẫu I-94 hết hạn, và thời gian ân hạn sau khi hoàn tất chương trình học rút ngắn từ 60 xuống còn 30 ngày.",
    "news.n3.tag": "Dịch Vụ Lãnh Sự",
    "news.n3.title": "Bộ Ngoại Giao Hoa Kỳ Hợp Nhất Dịch Vụ Visa Tại 25 Cơ Quan Đại Diện Ở Châu Phi Về Các Trung Tâm Khu Vực",
    "news.n3.desc": "Có hiệu lực từ ngày 1/8/2026, Bộ Ngoại Giao Hoa Kỳ tái cơ cấu dịch vụ visa định kỳ (cả diện di dân và không di dân) tại 25 cơ quan đại diện ngoại giao ở Châu Phi — bao gồm Nigeria, Zimbabwe và Mali — về mạng lưới 20 trung tâm visa khu vực nhằm thống nhất tiêu chuẩn sàng lọc và xét duyệt. Bộ Ngoại Giao cho biết thay đổi này chỉ ảnh hưởng đến nơi xử lý hồ sơ visa, không làm thay đổi tình trạng hoạt động của các đại sứ quán và lãnh sự quán.",
