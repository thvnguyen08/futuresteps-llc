...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Cập Nhật Thẻ Xanh",
    "news.n1.title": "Quy Định Mới Của DHS Cho Phép USCIS Từ Chối Hồ Sơ Thẻ Xanh Vì Lỗi Chữ Ký",
    "news.n1.desc": "Hàng loạt thay đổi chính sách có hiệu lực từ tháng 7/2026, kết hợp giới hạn mới của Bản Tin Visa với quy định của DHS (hiệu lực từ 10/7) cho phép USCIS từ chối hồ sơ vì thiếu chữ ký hợp lệ — kể cả sau khi hồ sơ đã được tiếp nhận xử lý. Visa EB-2 và EB-5 (diện không dành riêng) cho người sinh tại Ấn Độ hiện không còn khả dụng đến hết năm tài chính.",
    "news.n2.tag": "Phán Quyết Chính Sách",
    "news.n2.title": "Tối Cao Pháp Viện Mở Đường Chấm Dứt TPS Cho Công Dân Haiti và Syria",
    "news.n2.desc": "Ngày 25/6/2026, Tối Cao Pháp Viện Hoa Kỳ ra phán quyết 6-3 cho phép chính quyền Trump chấm dứt Quy Chế Bảo Vệ Tạm Thời (TPS) đối với khoảng 350.000 người Haiti và hàng nghìn người Syria, xóa bỏ rào cản pháp lý cuối cùng. DHS cho biết giấy phép lao động theo diện TPS của các nhóm này sẽ hết hạn vào ngày 10/7/2026.",
    "news.n3.tag": "Visa Đầu Tư EB-5",
    "news.n3.title": "Chính Quyền Trump Đề Xuất Cải Tổ Lớn Chương Trình Visa Đầu Tư EB-5",
    "news.n3.desc": "Chính quyền đã công bố đề xuất cải tổ toàn diện chương trình visa đầu tư định cư EB-5, áp đặt yêu cầu tuân thủ mới cho các trung tâm khu vực, tăng cường chống gian lận và trao quyền thu hồi quyền lợi rộng hơn khi phát hiện gian lận hoặc rủi ro an ninh quốc gia. Nhà đầu tư có thể sẽ bị kiểm tra kỹ hơn về nguồn vốn khi xét duyệt đơn I-526/I-526E.",
