...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Cập Nhật Chính Sách",
    "news.n1.title": "DHS Bãi Bỏ Quy Định \"Gánh Nặng Xã Hội\" (Public Charge) Năm 2022, Trao Quyền Quyết Định Rộng Hơn Cho Viên Chức USCIS",
    "news.n1.desc": "Bộ An Ninh Nội Địa Hoa Kỳ (DHS) đã ban hành quy định chính thức vào ngày 20/7/2026, bãi bỏ hoàn toàn quy định \"gánh nặng xã hội\" (public charge) từ thời chính quyền Biden năm 2022 — xóa bỏ các định nghĩa và khung xét duyệt trước đó thay vì thay thế bằng quy định mới. Có hiệu lực từ ngày 18/9/2026, viên chức USCIS sẽ được toàn quyền xem xét khả năng tự lập tài chính của đương đơn theo từng trường hợp cụ thể, và mẫu đơn I-485 phiên bản mới sẽ bắt buộc áp dụng cho các hồ sơ xin thẻ xanh nộp từ ngày đó trở đi.",
    "news.n2.tag": "Phán Quyết Tòa Án",
    "news.n2.title": "Tòa Án Liên Bang Chặn Các Chính Sách Trọng Yếu Theo H.R. 1 Ảnh Hưởng Đến Người Diện TPS Và Xin Tị Nạn",
    "news.n2.desc": "Ngày 21/7/2026, Tòa Án Quận Liên Bang Massachusetts đã chấp thuận một phần đơn khẩn cấp yêu cầu tạm hoãn thi hành các chính sách của USCIS theo H.R. 1 (Đạo Luật Hòa Giải Ngân Sách 2025) — chỉ một ngày trước khi các quy định này có hiệu lực. Phán quyết giữ nguyên ngày hết hạn trước đó của các giấy phép lao động (EAD) diện TPS đã được gia hạn, đồng thời ngăn USCIS từ chối đơn xin tị nạn vì lý do chưa nộp một số khoản phí nhất định. Tòa sẽ quyết định trước ngày 5/8/2026 có gia hạn lệnh tạm hoãn này trong khi vụ kiện tiếp tục hay không.",
    "news.n3.tag": "Cập Nhật TPS",
    "news.n3.title": "USCIS Cập Nhật Hướng Dẫn Về Việc Chấm Dứt Tình Trạng Bảo Vệ Tạm Thời (TPS) Của Haiti",
    "news.n3.desc": "USCIS công bố thông báo cập nhật vào ngày 24/7/2026 xác nhận việc chấm dứt diện TPS dành cho Haiti, thay thế hướng dẫn trước đó ban hành ngày 10/7. Giấy phép lao động (EAD) diện TPS của Haiti vẫn tiếp tục được gia hạn theo lệnh tòa án hiện hành, như một biện pháp bảo vệ tạm thời cho đến khi Tối Cao Pháp Viện ban hành phán quyết chính thức trong vụ Mullin v. Doe; người sử dụng lao động khi điền Mẫu I-9 cần ghi \"as per court order\" ở Mục 1 và \"July 27, 2026\" ở Mục 2.",
