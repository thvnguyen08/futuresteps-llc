...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Kiện Tụng",
    "news.n1.title": "Liên Minh Đại Học &amp; Vận Động Chính Sách Kiện DHS Để Ngăn Quy Định Bãi Bỏ \"Duration of Status\" Cho Diện F, J, I",
    "news.n1.desc": "Ngày 18/8/2026, một liên minh do Presidents' Alliance on Higher Education and Immigration và NAFSA dẫn đầu — cùng các hiệp hội đại học và công đoàn lao động — đã nộp đơn kiện tại Tòa Án Liên Bang Khu Vực Massachusetts, yêu cầu lệnh cấm tạm thời đối với quy định của DHS nhằm bãi bỏ chế độ \"Duration of Status\" (thời hạn lưu trú theo chương trình) cho diện không định cư F, J và I. Quy định này, dự kiến có hiệu lực từ ngày 15/9/2026, sẽ giới hạn thời gian lưu trú tối đa 4 năm thay vì theo suốt thời gian chương trình học; liên minh cho rằng DHS đã không thực hiện đầy đủ quy trình lấy ý kiến công chúng.",
    "news.n2.tag": "Mẫu Đơn USCIS",
    "news.n2.title": "USCIS Sẽ Thay Mẫu I-539 và I-765 Từ Ngày 15/9 — Không Có Thời Gian Ân Hạn Cho Mẫu Cũ",
    "news.n2.desc": "Ngày 14/8/2026, USCIS thông báo sẽ ban hành phiên bản mới ngày 15/9/2026 của Mẫu I-539 (Đơn Xin Gia Hạn/Thay Đổi Diện Không Định Cư) và Mẫu I-765 (Đơn Xin Giấy Phép Lao Động) để áp dụng quy định mới về thời hạn nhập cảnh cố định cho diện F, J và I. Sẽ không có thời gian ân hạn: USCIS sẽ từ chối hồ sơ dùng mẫu cũ nếu đóng dấu bưu điện hoặc nộp điện tử từ ngày 15/9/2026 trở đi, vì vậy du học sinh, khách trao đổi và người xin giấy phép lao động nên chuẩn bị nộp hồ sơ sớm.",
    "news.n3.tag": "Bản Tin Visa",
    "news.n3.title": "Bản Tin Visa Tháng 9/2026: Diện Gia Đình Tiến Vọt Nhiều Năm, Diện Lao Động Giữ Nguyên",
    "news.n3.desc": "Bản Tin Visa Tháng 9/2026 của Bộ Ngoại Giao Hoa Kỳ, công bố ngày 22/8/2026, cho thấy các diện gia đình bảo lãnh tiến mạnh: F1 tiến khoảng 13 tháng, F2B gần 20 tháng, F3 tiến 29 tháng và F4 tiến gần 26 tháng. Trong khi đó, các diện lao động EB-1, EB-2, EB-3 và EB-5 giữ nguyên so với tháng 8, riêng EB-4 tiến 2 tháng; diện EB-2 và EB-5 Không Dự Trữ (Unreserved) của Ấn Độ tiếp tục không có số visa (unavailable) sang tháng thứ ba liên tiếp.",
