...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Xử Lý Lãnh Sự",
    "news.n1.title": "Bộ Ngoại Giao Mỹ Tạm Ngừng Phỏng Vấn Visa Định Cư Trên Toàn Cầu Để Đào Tạo Về \"Public Charge\"",
    "news.n1.desc": "Ngày 25/8/2026, Bộ Ngoại Giao Hoa Kỳ xác nhận đã tạm ngừng lịch hẹn phỏng vấn visa định cư (thẻ xanh) tại các đại sứ quán và lãnh sự quán Mỹ trên toàn thế giới, trong lúc nhân viên lãnh sự hoàn tất khóa đào tạo mới về sàng lọc \"public charge\" (khả năng phụ thuộc phúc lợi công) mở rộng. Đương đơn đã có lịch hẹn được thông báo lịch phỏng vấn sẽ bị dời lại, chưa có ngày mới; các loại visa không định cư như B-1/B-2, F-1 và H-1B không bị ảnh hưởng.",
    "news.n2.tag": "Thu Hồi Visa",
    "news.n2.title": "Chính Quyền Trump Chuẩn Bị Đợt Thu Hồi Visa Quy Mô Lớn Nhất Lịch Sử Mỹ, Nhắm Đến 200.000 Người Xin Tị Nạn",
    "news.n2.desc": "Ngày 25/8/2026, các quan chức Bộ Ngoại Giao cho biết đang chuẩn bị thu hồi visa thương mại/du lịch (B-1/B-2) đã cấp trong giai đoạn 2016-2026 của tối đa 200.000 người nước ngoài sau đó đã nộp đơn xin tị nạn — được gọi là đợt thu hồi visa hàng loạt lớn nhất trong lịch sử Hoa Kỳ. Việc thu hồi dự kiến triển khai theo từng đợt và, theo các quan chức, sẽ không tự động dẫn đến trục xuất nhưng sẽ xóa bỏ tình trạng không định cư hiện có của người bị thu hồi.",
    "news.n3.tag": "Mẫu Đơn USCIS",
    "news.n3.title": "USCIS Sẽ Thay Mẫu I-539 và I-765 Từ Ngày 15/9 — Không Có Thời Gian Ân Hạn Cho Mẫu Cũ",
    "news.n3.desc": "Ngày 14/8/2026, USCIS thông báo sẽ ban hành phiên bản mới ngày 15/9/2026 của Mẫu I-539 (Đơn Xin Gia Hạn/Thay Đổi Diện Không Định Cư) và Mẫu I-765 (Đơn Xin Giấy Phép Lao Động) để áp dụng quy định mới về thời hạn nhập cảnh cố định cho diện F, J và I. Sẽ không có thời gian ân hạn: USCIS sẽ từ chối hồ sơ dùng mẫu cũ nếu đóng dấu bưu điện hoặc nộp điện tử từ ngày 15/9/2026 trở đi, vì vậy du học sinh, khách trao đổi và người xin giấy phép lao động nên chuẩn bị nộp hồ sơ sớm.",
