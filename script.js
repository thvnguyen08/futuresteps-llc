...
const translations = {
  vi: {
    ...
    "news.n2.tag": "Cảnh Báo Visa Du Học",
    "news.n2.title": "DHS Chấm Dứt Chế Độ \"Lưu Trú Không Xác Định Thời Hạn\" Cho Du Học Sinh F-1 — Áp Dụng Thời Hạn Cố Định Từ 15/9",
    ...
    "news.n3.tag": "Cập Nhật Visa Lao Động",
    "news.n3.title": "USCIS Xác Nhận Đã Đủ Chỉ Tiêu H-1B Năm Tài Khóa 2027 — Không Tổ Chức Bốc Thăm Vòng Hai",
    "news.n3.desc": "USCIS thông báo ngày 17/7/2026 rằng cơ quan đã nhận đủ hồ sơ để lấp đầy cả hạn ngạch H-1B thường niên 65.000 suất và diện miễn trừ bằng thạc sĩ Hoa Kỳ 20.000 suất cho năm tài khóa 2027, và sẽ không tổ chức thêm vòng bốc thăm bổ sung. Đây là chu kỳ đầu tiên áp dụng hệ thống chọn lọc theo mức lương mới của DHS, với gần 72% người được chọn có bằng thạc sĩ Hoa Kỳ trở lên, tăng so với 57% ở chu kỳ trước.",
