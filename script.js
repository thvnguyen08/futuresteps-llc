...
const translations = {
  vi: {
    ...
    "news.n3.tag": "Bắt Buộc Nộp Điện Tử",
    "news.n3.title": "Quy Định Mới Của DHS Cho Phép USCIS Bắt Buộc Nộp Hồ Sơ Điện Tử",
    "news.n3.desc": "Quy định tạm thời (interim final rule) của DHS có hiệu lực từ ngày 11/8/2026, cho phép USCIS bắt buộc nộp điện tử đối với bất kỳ hồ sơ nào đã có sẵn hình thức nộp điện tử trong ít nhất 180 ngày. USCIS phải thông báo công khai trước ít nhất 60 ngày trước khi bắt buộc một mẫu đơn cụ thể chỉ được nộp trực tuyến, và người không thể nộp điện tử có thể xin miễn trừ vì lý do khó khăn.",
