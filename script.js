...
const translations = {
  vi: {
    ...
    "news.n1.tag": "Cập Nhật Mẫu Đơn",
    "news.n1.title": "USCIS Từ Chối Mẫu I-539/I-765 Cũ Từ Ngày 15/9 — Không Có Thời Gian Ân Hạn",
    "news.n1.desc": "Ngày 14/8/2026, USCIS thông báo mẫu đơn phiên bản mới 09/15/26 của Mẫu I-539 (Gia Hạn/Thay Đổi Diện Không Định Cư) và Mẫu I-765 (Xin Giấy Phép Lao Động) sẽ bắt buộc áp dụng từ ngày 15/9, nhằm thực thi quy định thay thế \"Thời Gian Lưu Trú\" (D/S) bằng thời hạn nhập cảnh cố định cho diện F, J và I. Không có thời gian ân hạn — bất kỳ đơn I-539 hoặc I-765 nào đóng dấu bưu điện hoặc nộp điện tử từ ngày 15/9 trở đi mà dùng mẫu cũ sẽ bị từ chối ngay, vì vậy sinh viên, khách trao đổi và người phụ thuộc đang gia hạn diện hoặc giấy phép lao động nên chuyển sang dùng mẫu mới ngay từ bây giờ.",
    "news.n2.tag": "Quy Định Public Charge",
    "news.n2.title": "Quy Định Public Charge Mới Có Hiệu Lực Từ 18/9 — USCIS Ra Mắt Mẫu I-485 Sửa Đổi",
    "news.n2.desc": "Hướng dẫn của USCIS ban hành ngày 18/8/2026 xác nhận rằng từ ngày 18/9, viên chức có thể xem xét phạm vi phúc lợi công rộng hơn — bao gồm tem phiếu thực phẩm (SNAP), Medicaid và hỗ trợ nhà ở nhận được từ ngày đó trở đi — khi quyết định đương đơn xin thẻ xanh có khả năng trở thành \"public charge\" (gánh nặng phúc lợi công) hay không. Mẫu I-485 phiên bản 09/18/26 bắt buộc sử dụng từ ngày đó, không có thời gian ân hạn cho mẫu cũ, dù hồ sơ nộp trước đó vẫn được xét theo tiêu chuẩn cũ.",
    "news.n3.tag": "Siết Chặt CPT",
    "news.n3.title": "Công Văn SEVP Siết Quy Định CPT Cho Sinh Viên F-1; UCLA, UC Berkeley Tạm Dừng Duyệt Đơn",
    "news.n3.desc": "Công văn của SEVP ngày 24/8/2026 yêu cầu các trường đại học chỉ cấp phép Đào Tạo Thực Hành Theo Chương Trình (CPT) khi kỳ thực tập là phần bắt buộc, gắn liền với chương trình học của mọi sinh viên trong ngành — không riêng sinh viên quốc tế — và cảnh báo trường nào không tuân thủ có thể bị thu hồi chứng nhận SEVP để tuyển sinh quốc tế. UCLA và UC Berkeley đã tạm dừng cấp một số phép CPT trong lúc xem xét hướng dẫn này, vì vậy sinh viên diện F-1 nên xác nhận với cố vấn DSO về điều kiện CPT của chương trình trước khi nhận lời mời thực tập.",
