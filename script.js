...
const translations = {
  vi: {
    ...
    "news.n1.title": "Chương Trình Nghị Sự Của Bộ Lao Động Báo Hiệu Cải Tổ Quy Trình Chứng Nhận Lao Động PERM",
    "news.n1.desc": "Chương trình nghị sự pháp quy mới công bố của Bộ Lao Động Hoa Kỳ cho thấy kế hoạch hiện đại hóa quy trình chứng nhận lao động PERM — bước bắt buộc với phần lớn hồ sơ thẻ xanh diện lao động — vốn chưa được cập nhật đáng kể từ năm 2004. Các thay đổi đề xuất bao gồm yêu cầu tuyển dụng và hồ sơ chặt chẽ hơn, điều mà các luật sư di trú cảnh báo có thể kéo dài thêm một quy trình vốn đã rất lâu.",
