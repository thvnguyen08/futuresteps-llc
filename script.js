...
const translations = {
  vi: {
    ...
    "vb.title": "Bản Tin Visa — Tháng 8/2026",
    ...
    "news.n1.tag": "Chính Sách USCIS",
    "news.n1.title": "USCIS Cho Biết Có Thể Từ Chối Hồ Sơ Mà Không Cần Gửi Yêu Cầu Bổ Sung Bằng Chứng (RFE) Hoặc Thông Báo Ý Định Từ Chối (NOID)",
    "news.n1.desc": "Ngày 5/8/2026, USCIS ban hành Thông Báo Chính Sách PA-2026-05, cập nhật Sổ Tay Chính Sách USCIS để nêu rõ viên chức có thể từ chối hồ sơ xin quyền lợi di trú thiếu bằng chứng ban đầu bắt buộc hoặc không chứng minh đủ điều kiện, mà không cần gửi Yêu Cầu Bổ Sung Bằng Chứng (RFE) hay Thông Báo Ý Định Từ Chối (NOID) trước. Hướng dẫn có hiệu lực ngay lập tức và áp dụng cho mọi hồ sơ đang chờ xử lý lẫn hồ sơ mới nộp, vì vậy USCIS cảnh báo người nộp đơn không nên mặc định sẽ có cơ hội bổ sung bằng chứng còn thiếu sau khi đã nộp hồ sơ.",
    "news.n2.tag": "Public Charge",
    "news.n2.title": "DHS Bãi Bỏ Quy Định Public Charge Năm 2022; Tiêu Chuẩn Xét Duyệt Từng Trường Hợp Mới Áp Dụng Từ 18/9",
    "news.n2.desc": "Ngày 16/7/2026, DHS chính thức ban hành quy định bãi bỏ quy định public charge (gánh nặng xã hội) năm 2022, cho phép viên chức USCIS có thẩm quyền rộng hơn khi cân nhắc việc đương đơn sử dụng các phúc lợi có xét thu nhập như Medicaid, SNAP và hỗ trợ nhà ở khi xét hồ sơ thẻ xanh và điều chỉnh diện cư trú. Tiêu chuẩn mới áp dụng cho mẫu I-485 và đơn xin nhập cảnh nộp từ ngày 18/9/2026 trở đi; hồ sơ nộp trước ngày đó vẫn được xét theo khung quy định năm 2022 sắp hết hiệu lực.",
    "news.n3.tag": "Visa H-1B",
    "news.n3.title": "USCIS Xác Nhận Đã Đạt Hạn Ngạch H-1B Năm Tài Khóa 2027, Đóng Cửa Nhận Hồ Sơ Mới",
    "news.n3.desc": "Ngày 17/7/2026, USCIS thông báo đã nhận đủ hồ sơ để đạt hạn ngạch H-1B thường niên 65.000 suất theo luật định cộng với 20.000 suất miễn trừ dành cho người có bằng cấp cao tại Hoa Kỳ cho năm tài khóa 2027, và sẽ không tổ chức đợt chọn hồ sơ bổ sung. Đây là kỳ đầu tiên áp dụng hệ thống chọn hồ sơ dựa trên mức lương mới của DHS, ưu tiên các hồ sơ đăng ký gắn với mức lương đề nghị cao hơn.",
