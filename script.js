...
const translations = {
  vi: {
    ...
    "news.n1.tag": "USCIS Mở Rộng",
    "news.n1.title": "USCIS Mở Văn Phòng Quốc Tế Mới Tại Addis Ababa, Ethiopia",
    "news.n1.desc": "USCIS thông báo mở văn phòng quốc tế mới tại Addis Ababa, Ethiopia, bắt đầu hoạt động từ ngày 9/9/2026 để xác minh giấy tờ nước ngoài, điều tra gian lận và xét nghiệm ADN cho hồ sơ di trú diện gia đình. Văn phòng chỉ làm việc theo lịch hẹn, giúp USCIS có sự hiện diện trực tiếp tại khu vực thay vì chỉ dựa vào hỗ trợ lãnh sự của Bộ Ngoại Giao.",
    "news.n2.tag": "Phí H-1B",
    "news.n2.title": "DHS Đề Xuất Phí 103.265 USD Cho Mỗi Đơn H-1B Diện Cap",
    "news.n2.desc": "Ngày 25/8/2026, DHS công bố dự thảo quy định bổ sung khoản phí 103.265 USD cho mỗi đơn H-1B diện cap, phải nộp khi nộp hồ sơ, cộng thêm vào các lệ phí chính phủ hiện có, kể cả đơn được miễn diện bằng cấp cao. Khoản phí này không áp dụng cho nhà tuyển dụng được miễn cap hoặc đơn gia hạn/chuyển đổi H-1B hiện có, và DHS đang nhận ý kiến công chúng đến hết ngày 24/9/2026 trước khi ban hành quy định chính thức.",
    "news.n3.tag": "Quy Định Public Charge",
    "news.n3.title": "Quy Định Public Charge Mới Có Hiệu Lực Từ 18/9 — USCIS Ra Mắt Mẫu I-485 Sửa Đổi",
    "news.n3.desc": "Hướng dẫn của USCIS ban hành ngày 18/8/2026 xác nhận rằng từ ngày 18/9, viên chức có thể xem xét phạm vi phúc lợi công rộng hơn — bao gồm tem phiếu thực phẩm (SNAP), Medicaid và hỗ trợ nhà ở nhận được từ ngày đó trở đi — khi quyết định đương đơn xin thẻ xanh có khả năng trở thành \"public charge\" (gánh nặng phúc lợi công) hay không. Mẫu I-485 phiên bản 09/18/26 bắt buộc sử dụng từ ngày đó, không có thời gian ân hạn cho mẫu cũ, dù hồ sơ nộp trước đó vẫn được xét theo tiêu chuẩn cũ.",
